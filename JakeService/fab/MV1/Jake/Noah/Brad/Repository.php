...
class Repository implements RepositoryInterface
{
    ...
    {
        return $this->getNeighborhoodsPrefabExamplesJakeServiceMV1JakeNoahBradBuilderFactory()->create();
    }

    public function get(\Neighborhoods\PrefabExamplesJakeService\SearchCriteriaInterface $searchCriteria) : \Neighborhoods\Prefab\Repository\Neighborhoods\PrefabExamplesJakeService\MV1\Jake\Noah\Brad\MapInterface
    {
        ...
        $queryBuilder->from(Neighborhoods\PrefabExamplesJakeService\MV1\Jake\Noah\BradInterface::TABLE_NAME)->select('*');
        $records = $queryBuilder->execute()->fetchAll();

        return $this->createBuilder()->setRecords($records)->build();
    }

    public function save(\Neighborhoods\Prefab\Repository\MapInterface $map) : \Neighborhoods\Prefab\Repository\Neighborhoods\PrefabExamplesJakeService\MV1\Jake\Noah\Brad\RepositoryInterface
    {
